  ...
  <div class="nf-container">
    <div>
      ...
      <div class="form-responses">
        ...
        <div class="form-responses__error js-newsletter-error-text">Ein Fehler ist aufgetreten. Haben Sie sich eventuell vertippt oder sind Sie bereits im Verteiler?</div>
      </div>
    </div>
  </div>
</template>